...
public class staffItem extends ToolItem implements Vanishable {
    ...
    public staffItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, TagKey<Block> effectiveBlocks, Item.Settings settings) {
